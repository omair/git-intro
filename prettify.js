...
(function () {
  ...
  var PYTHON_KEYWORDS = FLOW_CONTROL_KEYWORDS + "and as assert class def del " +
      "elif except exec finally from global system git config import in is lambda " +
  ...
  var GIT_KEYWORDS = FLOW_CONTROL_KEYWORDS + "git push config commit merge branch system status add branch";

  var ALL_KEYWORDS = (
      CPP_KEYWORDS + CSHARP_KEYWORDS + JSCRIPT_KEYWORDS + PERL_KEYWORDS +
      PYTHON_KEYWORDS + RUBY_KEYWORDS + SH_KEYWORDS + GIT_KEYWORDS);
